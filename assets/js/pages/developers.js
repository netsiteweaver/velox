$(document).ready(function(){
  ...
  $('document').ready(function(){
    ...
    $('.update_permission').on('click', function () {
        ...
        var url = base_url + 'developers/save_permission/';
        ...
        $.ajax({
            ...
            complete: function() {
                ...
                window.location.href=base_url+"developers/listing";
            }
        })
    ...
    $.ajax({
      method:"POST",
      url:base_url+"developers/check_username_email",
      data:{username:username,email:email,level:'normal'},
      dataType:"JSON",
      success:function(response){
        ...
        if(!valid){
          ...
          $.ajax({
            url: base_url + "developers/insert",
            method: "POST",
            ...
            success:function(response){
              ...
              if(response.result){
                window.location.href = "developers/listing";
              }
            }
          })
        }
  ...
  $("#update").on("click",function(){
    ...
    if(level == 'Normal'){
      ...
      $.ajax({
        url: base_url + "developers/update",
        method: "POST",
        processData: false,
        contentType: false,
        data: formData,
