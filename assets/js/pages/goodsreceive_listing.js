jQuery(function(){
    ...
    $('.daterange').daterangepicker({
        ...
        let qs = base_url + "goodsreceive/listing?start_date="+start.format("YYYY-MM-DD")+"&end_date="+end.format("YYYY-MM-DD")+"&search_text="+search_text+"&stage="+stage;
    ...
    $('#apply-filter').on('click',function(){
        let search_text = $('#search_text').val();
        let rpp = $('#rpp').val();
        let qs = base_url + "goodsreceive/listing?start_date="+selectedStartDate+"&end_date="+selectedEndDate+"&search_text="+search_text+ "&display="+rpp;
