...
(function () {
	...
	function createTooltip(id, sourceElem, options) {
		...
		html += "<div style='color:" + options["color"] + "' class = 'contentDrooltip'>";
		html += content;
		html += "</div>";
	...
	function updateDynamicContent(id, element, source, position, content) {
		element.querySelector(".contentDrooltip .drooltipLoader").classList.add("stop");
		setTimeout(function () {
			element.querySelector(".contentDrooltip").classList.add("showDynamic");
			setTimeout(function () {
				element.querySelector(".contentDrooltip").innerHTML = content;
				element.querySelector(".contentDrooltip").classList.remove("showDynamic");
