                                                        ...
                                                        <tr>
                                                            <td style="width:200px;">
                                                                <img alt="logo" height="auto"
                                                                    src="<?php echo base_url("assets/images/".$logo);?>"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">
                                                    We have received a request to reset your password for this email. </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">
                                                    Click on the link below to reset your password. Another email will be sent containing your newly generated password. </div>
                                            </td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center" bgcolor="#2e58ff" role="presentation"
                                                                ...
                                                                valign="middle">
                                                                <a href="<?php echo base_url($resetLink.$token.'/'.urlencode($email));?>"
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">
                                                    If you need any help, don’t hesitate to reach out to us at <a
                                                        href="#"
