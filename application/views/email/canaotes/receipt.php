                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">
                        <h1 style="margin: 0; font-size: 24px; line-height: normal; font-weight: bold;"> Hi John Doe, <br /> thanks for your order </h1>
                      </div>
                    </td>
                  </tr>
                </tbody></table>
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody><tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">
                        <p style="margin: 0;">Your order (#2342342) was successfully placed and your payment has been processed. Here is your order summary: </p>
                      </div>
                    </td>
                  </tr>
                </tbody></table>
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;table-layout:auto;width:100%;border:none;">
                        <tbody><tr valign="top">
                          <td width="60%" style="font-size: 16px; line-height: 20px; word-break: normal;">
                            ...
                            <p style="margin: 0; color: #ACA9BB; padding-bottom: 10px;"> by Company ABC </p>
                          </td>
                        ...
                        <tr valign="top">
                          <td width="60%" style="font-size: 16px; line-height: 20px; word-break: normal;">
                            <p style="margin: 0;"> Product 2 / More product info </p>
                            <p style="margin: 0; color: #ACA9BB; padding-bottom: 10px;"> by the Classic Company </p>
                          </td>
                          <td align="right" style="font-size: 16px; line-height: 20px; word-break: normal; padding-top: 20px; padding-right: 5px;">
                            <p style="margin: 0;">x1</p>
                          </td>
                        ...
                        <tr>
                          ...
                          <td align="right" style="font-size: 16px; line-height: 20px; word-break: normal; padding-top: 20px;"><strong>$61.93</strong></td>
                        </tr>
                      </tbody></table>
                    </td>
                  </tr>
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody><tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">
                        <p style="margin: 0;">If you want to track your order, click the button below. </p>
                      </div>
                    </td>
                  </tr>
                  <tr>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                        <tbody><tr>
                          <td align="center" bgcolor="#2e58ff" role="presentation" style="border:none;border-radius:30px;cursor:auto;mso-padding-alt:10px 25px;background:#2e58ff;" valign="middle">
                            <a href="https://google.com" style="display: inline-block; background: #2e58ff; color: #ffffff; font-family: Helvetica, Arial, sans-serif; font-size: 14px; font-weight: bold; line-height: 30px; margin: 0; text-decoration: none; text-transform: uppercase; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 30px;" target="_blank"> Track my order </a>
                          </td>
                        </tr>
                      </tbody></table>
                    </td>
