                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Hi <?php echo $new_user['data']['name']; ?>,</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <?php echo "<strong>Name</strong>: ".$new_user['data']['name']."<br>";?>
                                            <?php echo "<strong>Job Title</strong>: ".$new_user['data']['job_title']."<br>";?>
                                            <?php echo "<strong>Username</strong>: ".$new_user['data']['username']."<br>";?>
                                            <?php if($new_user['data']['generate_password']=='yes'):?>
                                            <?php echo "<strong>Password</strong>: ".$new_user['data']['password']."<br>";?>
                                            <?php endif;?>
                                            <?php echo "<strong>Email</strong>: ".$new_user['data']['email']."<br>";?>
                                            <?php echo "<strong>Level</strong>: ".$new_user['data']['level']."<br>";?>
                                        ...
                                        <tr>
                                            <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">You can connect to your account here: 
                                                <p><a href="<?php echo base_url('users/signin/'.$new_user['data']['uuid']);?>" target="_blank"><?php echo base_url('users/signin/'.$new_user['data']['uuid']);?></a></p>
                                            </td>
                                        </tr>
