...
|
*/
$config['base_url']	= 'https://veloxmail.online/';

/*
|--------------------------------------------------------------------------
| Maintenance Mode (added by Reeaz Ramoly / 2019-03-26)
|--------------------------------------------------------------------------
|
...
$config['mailer'] = "mailer@mauriapp.info";

@define('TIMEZONE','Indian/Mauritius');
date_default_timezone_set (TIMEZONE);
$config['upload_folder'] = '/var/www/html/sites/mb/uploads/';